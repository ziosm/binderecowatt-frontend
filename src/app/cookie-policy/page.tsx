          ...
          <div className="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow-lg text-gray-700 space-y-6">
            ...
            <ul className="list-disc list-inside pl-4">
              ...
              <li>
                ...
                <p class="mt-2">Per maggiori informazioni su Google Analytics e per disabilitare i relativi cookie, è possibile consultare i seguenti link:</p>
                <ul class="list-circle list-inside pl-6">
                    <li><a href="https://policies.google.com/privacy?hl=it" target="_blank" rel="noopener noreferrer" class="text-green-600 hover:underline">Privacy Policy di Google</a></li>
                    <li><a href="https://tools.google.com/dlpage/gaoptout?hl=it" target="_blank" rel="noopener noreferrer" class="text-green-600 hover:underline">Componente aggiuntivo del browser per la disattivazione di Google Analytics</a></li>
                </ul>
              </li>
              <li>
            ...
            <ul className="list-disc list-inside pl-4">
                <li>Chrome: <a href="https://support.google.com/chrome/answer/95647?hl=it" target="_blank" rel="noopener noreferrer" class="text-green-600 hover:underline">https://support.google.com/chrome/answer/95647?hl=it</a></li>
                <li>Firefox: <a href="https://support.mozilla.org/it/kb/Gestione%20dei%20cookie" target="_blank" rel="noopener noreferrer" class="text-green-600 hover:underline">https://support.mozilla.org/it/kb/Gestione%20dei%20cookie</a></li>
                <li>Internet Explorer / Edge: <a href="https://support.microsoft.com/it-it/help/17442/windows-internet-explorer-delete-manage-cookies" target="_blank" rel="noopener noreferrer" class="text-green-600 hover:underline">https://support.microsoft.com/it-it/help/17442/windows-internet-explorer-delete-manage-cookies</a></li>
                <li>Safari: <a href="https://support.apple.com/it-it/guide/safari/sfri11471/mac" target="_blank" rel="noopener noreferrer" class="text-green-600 hover:underline">https://support.apple.com/it-it/guide/safari/sfri11471/mac</a></li>
            </ul>
            ...
            <p class="mt-8"><em>Questa è una Cookie Policy generica e dovrebbe essere revisionata da un consulente legale per assicurare la piena conformità con le normative vigenti e le specifiche necessità aziendali, inclusa l'eventuale implementazione di un Consent Management Platform (CMP).</em></p>
          </div>
        </section>
      </main>
