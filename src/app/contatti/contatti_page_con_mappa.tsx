            ...
            <div className="grid md:grid-cols-2 gap-12 items-start">
              ...
              <div className="space-y-8">
                ...
                <div className="bg-white p-8 rounded-lg shadow-xl">
                   ...
                   {/* Codice Iframe di Google Maps inserito qui sotto */}
                   <iframe 
                     src="https://maps.google.com/maps?q=Via%20Risorgimento%202%2C%2030030%20Vigonovo%20VE&t=&z=15&ie=UTF8&iwloc=&output=embed" 
                     width="100%" 
                     height="350" 
                     style={{ border:0 }}
